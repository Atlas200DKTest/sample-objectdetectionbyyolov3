...
1.  Obtain the source code package.
    ...
    Download all the code in the sample-objectdetection repository at  [https://github.com/Atlas200dk/sample-objectdetectionbyyolov3](https://github.com/Atlas200dk/sample-objectdetectionbyyolov3)  to any directory on Ubuntu Server where  Mind Studio  is located as the  Mind Studio  installation user, for example,  _/home/ascend/sample-objectdetctionbyyolov3_.
...
2. <a name="en-us_topic_0182554604_li2074865610364"></a>Obtain the source network model required by the application.
   ...
   **Table  1**  Models used in the detection network application
   ...
   <tbody><tr id="en-us_topic_0182554604_row1119187377"><td class="cellrowborder" valign="top" width="11.959999999999999%" headers="mcps1.2.4.1.1 "><p id="en-us_topic_0182554604_p7118189378"><a name="en-us_topic_0182554604_p7118189378"></a><a name="en-us_topic_0182554604_p7118189378"></a>yolov3</p>
   </td>
   ...
   <p id="en-us_topic_0182554604_p8394945195815"><a name="en-us_topic_0182554604_p8394945195815"></a><a name="en-us_topic_0182554604_p8394945195815"></a>It is a yolov3 model based on Caffe.</p>
   </td>
...
3. Convert the source network model to a Da Vinci model.
   ...
   2. On the **Convert Model**  page, set **Model File**  and  **Weight File**  to the model file and weight file downloaded in  [2](#en-us_topic_0182554604_li2074865610364), respectively.
      - Set  **Model Name**  to the model name in  [Table 1](#en-us_topic_0182554604_table19942111763710):  yolov3**.

      - Retain default values for other parameters.

        **Figure  1**  yolov3 model conversion configuration<a name="en-us_topic_0182554604_fig79252510407"></a>  
        ![](doc/source/img/yolov3-1.PNG "yolov3-1")

        

        ![](doc/source/img/yolov3-2.PNG "yolov3-1")


    3.  Click  **OK**  to start model conversion.
    
        After successful conversion, a .om Da Vinci model file is generated in the  **$HOME/tools/che/model-zoo/my-model/yolov3**  directory.
        
        Copy .om Da Vinci model file to script ：/home/ascend/sample-objectdetection/script/
...
3.  Run the application.
    ...
    **python3 run\_object\_detection\__yolov3.py -m  _yolov3.om_  -w  _416_  -h  _416_  -i**
    ...
    **_./dog.jpg_ -o  _./out_  **
    ...
    For other parameters, run the  **python3 run\_object\_detection\__yolov3.py --help**  command. For details, see the help information.
